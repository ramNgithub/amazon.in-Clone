      ...
      <div className="Midpart">
        ...
        <div className="products">
          ...
          <div className="carousel-container">
            <div>
              <p className="carousel-headings"> Bestsellers in Smartphones </p>
            </div>
            <div className="slider">
              <Carousel responsive={responsive}>
                {smartPhones.map((el) => (
          ...
          <div className="carousel-container">
            <div>
              <p className="carousel-headings"> Bestsellers in Shoes </p>
            </div>
            <div className="slider">
              <Carousel responsive={responsive}>
                {shoes.map((el) => (
          ...
          <div className="carousel-container">
            <div>
              <p className="carousel-headings"> Bestsellers in Skincare </p>
            </div>
            <div className="slider">
              <Carousel responsive={responsive}>
                {skincare.map((el) => (
          ...
          <div className="carousel-container">
            <div>
              <p className="carousel-headings"> Bestsellers in Watches </p>
            </div>
            <div className="slider">
              <Carousel responsive={responsive}>
                {watches.map((el) => (
